...
class Main {
  public static void main(String[] args) {
    ...
    do {
      try {
        menu(); // Procedimiento Mostrar el menu
        ...
        if (opcion < 0 || opcion > 4) {
          ...
          switch (opcion) {
            ...
            case 2:
              ...
              break;
            case 3:
              casoTres(in); // MULTIPLICAR
              break;
            case 4:
              casoCuatro(in); // DIVIDIR
              break;
          }
        }
  ...
  public static int restar(int numero1, int numero2) {
    return (numero1 > numero2) ? (numero1 - numero2) : (numero2 - numero1); // Resta
  }
  ...
  public static int dividir(int numero1, int numero2) {
    return (numero1 < numero2) ? (numero2 / numero1) : (numero1 / numero2); // División
  }
  ...
  // Procedimiento caso MULTIPLICACION
  ...
  // verifica que sea entero y positivo
